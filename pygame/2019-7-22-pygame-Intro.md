...
pygame (**the library**) is a Free and Open Source [python](https://www.python.org/) programming language library for making multimedia applications (like games) built on top of the excellent [SDL](http://www.libsdl.org/) library. Like SDL(Simple DirectMedia Layer), pygame is highly portable and runs on nearly every platform and operating system. 

For this time i m gonna use the pygame.mixer.music to play an audio file. A window is created to handle keyboard events for playback commands.
